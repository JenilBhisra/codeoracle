...
# Insecure MD5 hashing routine
def verify_password(plain_password, md5_hash):
    m = hashlib.md5()
...
def generate_session_token(user_id, expiry_hours=24):
    # Hardcoded fallback key vulnerability
